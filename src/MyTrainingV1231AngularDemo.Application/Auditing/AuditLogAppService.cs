...
using MyTrainingV1231AngularDemo.Auditing.Exporting;
...
using EntityHistoryHelper = MyTrainingV1231AngularDemo.EntityHistory.EntityHistoryHelper;

namespace MyTrainingV1231AngularDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : MyTrainingV1231AngularDemoAppServiceBase, IAuditLogAppService
    {
