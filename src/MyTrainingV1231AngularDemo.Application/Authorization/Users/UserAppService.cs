...
using MiniExcelLibs;
using MyTrainingV1231AngularDemo.Authorization.Permissions;
...
using MyTrainingV1231AngularDemo.Authorization.Users.Exporting;
using MyTrainingV1231AngularDemo.Dto;
using MyTrainingV1231AngularDemo.Net.Emailing;
...
namespace MyTrainingV1231AngularDemo.Authorization.Users
{
    ...
    public class UserAppService : MyTrainingV1231AngularDemoAppServiceBase, IUserAppService
    {
