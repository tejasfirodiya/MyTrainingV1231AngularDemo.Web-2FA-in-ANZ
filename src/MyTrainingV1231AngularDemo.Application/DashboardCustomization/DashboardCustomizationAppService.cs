...
using MyTrainingV1231AngularDemo.DashboardCustomization.Definitions;
using MyTrainingV1231AngularDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace MyTrainingV1231AngularDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : MyTrainingV1231AngularDemoAppServiceBase, IDashboardCustomizationAppService
    {
