...
using MyTrainingV1231AngularDemo.Migrations.Seed.Host;
...
namespace MyTrainingV1231AngularDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : MyTrainingV1231AngularDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<MyTrainingV1231AngularDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{MyTrainingV1231AngularDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{MyTrainingV1231AngularDemoConsts.ConnectionStringName}", constring);
        }
