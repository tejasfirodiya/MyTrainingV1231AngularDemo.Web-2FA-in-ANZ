...
using MyTrainingV1231AngularDemo.MultiTenancy.Payments.Paypal;
using MyTrainingV1231AngularDemo.MultiTenancy.Payments.PayPal;
...
{
    public class PayPalPaymentAppService : MyTrainingV1231AngularDemoAppServiceBase, IPayPalPaymentAppService
    {
