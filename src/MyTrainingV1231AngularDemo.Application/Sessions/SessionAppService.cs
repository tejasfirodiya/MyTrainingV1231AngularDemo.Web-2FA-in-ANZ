...
{
    public class SessionAppService : MyTrainingV1231AngularDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        CurrencySign = MyTrainingV1231AngularDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = MyTrainingV1231AngularDemoConsts.AllowTenantsToChangeEmailSettings,
