...
namespace MyTrainingV1231AngularDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : MyTrainingV1231AngularDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("MyTrainingV1231AngularDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
