...
{
    public class StripeGatewayManager : MyTrainingV1231AngularDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "MyTrainingV1231AngularDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + MyTrainingV1231AngularDemoConsts.Currency;
        }
