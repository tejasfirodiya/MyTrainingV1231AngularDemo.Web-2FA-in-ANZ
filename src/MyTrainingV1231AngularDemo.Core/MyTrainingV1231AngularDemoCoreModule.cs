...
using MyTrainingV1231AngularDemo.Authorization.Ldap;
...
using MyTrainingV1231AngularDemo.DynamicEntityProperties;
...
using MyTrainingV1231AngularDemo.WebHooks;
using Newtonsoft.Json;

namespace MyTrainingV1231AngularDemo
{
    [DependsOn(
        typeof(MyTrainingV1231AngularDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class MyTrainingV1231AngularDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            MyTrainingV1231AngularDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = MyTrainingV1231AngularDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, MyTrainingV1231AngularDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<MyTrainingV1231AngularDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTrainingV1231AngularDemoCoreModule).GetAssembly());
        }
