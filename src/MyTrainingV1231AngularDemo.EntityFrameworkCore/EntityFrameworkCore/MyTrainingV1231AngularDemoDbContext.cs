...
{
    public class MyTrainingV1231AngularDemoDbContext : AbpZeroDbContext<Tenant, Role, User, MyTrainingV1231AngularDemoDbContext>, IOpenIddictDbContext
    {
        ...
        public MyTrainingV1231AngularDemoDbContext(DbContextOptions<MyTrainingV1231AngularDemoDbContext> options)
            : base(options)
        {
