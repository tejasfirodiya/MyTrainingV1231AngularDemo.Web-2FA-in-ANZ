...
namespace MyTrainingV1231AngularDemo.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = MyTrainingV1231AngularDemoConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(MyTrainingV1231AngularDemoDbContext context)
        {
            _context = context;
        }
