...
namespace MyTrainingV1231AngularDemo.OpenIddict.Applications
{
    public class EfCoreOpenIddictApplicationRepository : MyTrainingV1231AngularDemoRepositoryBase<OpenIddictApplication, Guid>,
