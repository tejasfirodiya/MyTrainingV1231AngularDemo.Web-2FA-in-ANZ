...
using MyTrainingV1231AngularDemo.Core.Base;
using MyTrainingV1231AngularDemo.Core.Extensions;
using MyTrainingV1231AngularDemo.Dto;
using MyTrainingV1231AngularDemo.Types;

namespace MyTrainingV1231AngularDemo.Queries
{
    public class OrganizationUnitQuery : MyTrainingV1231AngularDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
