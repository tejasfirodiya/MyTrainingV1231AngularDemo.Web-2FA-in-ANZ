...
namespace MyTrainingV1231AngularDemo.Web.Security.Recaptcha
{
    public class RecaptchaValidator : MyTrainingV1231AngularDemoServiceBase, IRecaptchaValidator, ITransientDependency
    {
