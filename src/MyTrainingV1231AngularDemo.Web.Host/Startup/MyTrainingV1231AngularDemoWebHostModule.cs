...
using MyTrainingV1231AngularDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace MyTrainingV1231AngularDemo.Web.Startup
{
    ...
    public class MyTrainingV1231AngularDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MyTrainingV1231AngularDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTrainingV1231AngularDemoWebHostModule).GetAssembly());
        }
