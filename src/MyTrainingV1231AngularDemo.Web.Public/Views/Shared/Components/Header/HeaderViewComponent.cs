...
using MyTrainingV1231AngularDemo.Web.Public.Startup;
using MyTrainingV1231AngularDemo.Web.Session;
using MyTrainingV1231AngularDemo.Web.UiCustomization;

namespace MyTrainingV1231AngularDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : MyTrainingV1231AngularDemoViewComponent
    {
