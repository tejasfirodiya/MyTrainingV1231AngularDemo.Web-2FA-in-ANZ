...
namespace MyTrainingV1231AngularDemo.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<MyTrainingV1231AngularDemoDbContext>>()
            ...
            new MyTrainingV1231AngularDemoDbContext(builder.Options).Database.EnsureCreated();
        }
