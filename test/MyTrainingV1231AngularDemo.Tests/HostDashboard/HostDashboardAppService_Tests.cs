...
using MyTrainingV1231AngularDemo.MultiTenancy.HostDashboard;
...
namespace MyTrainingV1231AngularDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MyTrainingV1231AngularDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
